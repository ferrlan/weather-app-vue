<template>
    <div class="flex flex-col flex-1 items-center">
        ...
        <div v-if="route.query.preview" class="text-white p-4 bg-weather-secondary w-full text-center">
            <p>You are currently previewing this city, click the "+" icon to start following the city.</p>
        </div>
...
const openweatherKey = '9d493fe88834ba9e912f01be4bf7477f'; 

const getWeatherData = async () => {

    try { 

        const weatherData = await axios.get(`https://api.openweathermap.org/data/2.5/onecall?lat=${route.query.lat}&lon=${route.query.lng}&appid=${openweatherKey}&units=imperial`
        );
